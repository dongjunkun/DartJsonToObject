...
import main.kotlin.djk.yyy.jsontodart.utils.executeCouldRollBackAction
import java.net.URL
import java.util.*
...
class MakeKotlinClassAction : AnAction("MakeKotlinClass") {
    ...
    private fun insertKotlinCode(
        ...
        val codeMaker: DartClassCodeMaker
        try {
            codeMaker = DartClassCodeMaker(className, jsonString)
        ...
        val generateClassesString = codeMaker.makeDartClassCode()
