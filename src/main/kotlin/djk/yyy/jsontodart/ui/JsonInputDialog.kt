package main.kotlin.djk.yyy.jsontodart.ui
...
import main.kotlin.djk.yyy.jsontodart.utils.addComponentIntoVerticalBoxAlignmentLeft
 ...
 * Json input Dialog
 */
class JsonInputDialog(private val classsName: String, project: Project) : Messages.InputDialog(project, "Please input the class name and JSON String for generating Dart data class", "Make Dart Class Code", Messages.getInformationIcon(), "", myInputValidator) {
